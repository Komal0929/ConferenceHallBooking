...
CREATE TABLE `feedback_tbl` (
  ...
  CONSTRAINT `feedback_tbl_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user_info_tbl` (`user_id`),
  CONSTRAINT `feedback_tbl_ibfk_2` FOREIGN KEY (`booking_id`) REFERENCES `booking_tbl` (`booking_id`)
